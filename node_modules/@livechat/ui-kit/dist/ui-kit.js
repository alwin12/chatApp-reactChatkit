...
function () {
  ...
  _proto.speedy = function speedy(bool$$1) {
    if (this.ctr !== 0) {
...
function createEmotion(context, options) {
        ...
        if (typeof obj[key] !== 'object') {
          ...
          if (Array.isArray(obj[key]) && typeof obj[key][0] === 'string' && caches.registered[obj[key][0]] === undefined) {
            obj[key].forEach(function (value) {
              string$$1 += processStyleName(key) + ":" + processStyleValue(key, value) + ";";
            });
          } else {
  ...
  if (isBrowser) {
    ...
    Array.prototype.forEach.call(chunks, function (node$$1) {
      // $FlowFixMe
...
var createStyledIcon = memoize$2(
...
var _ref$1 = isBrowser$1 && window.requestAnimationFrame ? [window.requestAnimationFrame.bind(window), window.cancelAnimationFrame.bind(window)] : [setTimeout, clearTimeout];
var onNextFrame = _ref$1[0];
var clearNextFrameAction = _ref$1[1];
...
var ElementButtons = function (_React$Component) {
	inherits$1(ElementButtons, _React$Component);

	function ElementButtons() {
		var _temp, _this, _ret;

		classCallCheck$1(this, ElementButtons);

		for (var _len = arguments.length, args = Array(_len), _key2 = 0; _key2 < _len; _key2++) {
			args[_key2] = arguments[_key2];
		}

		return _ret = (_temp = (_this = possibleConstructorReturn$1(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.handleButtonClick = function (key) {
	...
	ElementButtons.prototype.render = function render() {
		...
		return React.createElement(
			...
			buttons.map(function (_ref, index) {
				var text = _ref.text,
				    _key = _ref.key,
				    buttonProps = objectWithoutProperties$1(_ref, ['text', 'key']);

				var key = _key !== undefined ? _key : index;
				return React.createElement(MessageButton, _extends$2({ key: key, label: text, onClick: _this2.handleButtonClick(key) }, buttonProps));
			})
		);
	};
...
var Link = function Link(props) {
	return React.createElement('a', _extends$2({}, props, { onClick: stopPropagation, rel: 'nofollow noopener', target: '_blank' }));
};
...
var Image = function Image(_ref) {
	var url = _ref.url,
	    srcset = _ref.srcset,
	    props = objectWithoutProperties$1(_ref, ['url', 'srcset']);
	return React.createElement(
		StyledMedia,
		props,
		React.createElement(
			...
			null,
			React.createElement('img', _extends$2({ alt: '', className: imageStyle }, getThumbnailProps(url, srcset)))
		)
	);
};
...
var CardImage = function CardImage(_ref2) {
	var link = _ref2.link,
	    props = objectWithoutProperties$1(_ref2, ['link']);
...
var Card = function (_React$Component) {
	inherits$1(Card, _React$Component);
...
var flatten$1 = function flatten(source) {
  return function (start, sink) {
    if (start !== 0) return;
...
var Carousel = function (_React$PureComponent) {
	inherits$1(Carousel, _React$PureComponent);
	...
	function Carousel() {
		...
		return _ret = (_temp = (_this = possibleConstructorReturn$1(this, _React$PureComponent.call.apply(_React$PureComponent, [this].concat(args))), _this), _this.state = {
		...
		}, _this.scrollToDirection = memoize$2(function (direction) {
			return function (event) {
				event.stopPropagation();
