...
var unpackCss = function unpackCss(props, css$$1) {
	var basedOnProps = dataUtils.pickBy(dataUtils.isObject, css$$1);
...
var AgentBar = function AgentBar(props) {
	return React.createElement(StyledBar, _extends({ verticalAlign: 'center' }, props));
};
...
var withThemeProps = (function (WrappedComponent) {
	...
	var WithThemeProps = function (_React$Component) {
		...
		WithThemeProps.prototype.render = function render() {
			...
			return React.createElement(WrappedComponent, _extends({}, themeProps, props));
		};
	...
	return emotionTheming.withTheme(WithThemeProps);
});
...
var Fill$1 = function Fill(props) {
	return React.createElement(StyledFill, _extends({ flexFill: true }, props));
};
...
var Fit$1 = function Fit(props) {
	return React.createElement(StyledFit, _extends({ flexFit: true }, props));
};
...
var _createContext = reactBroadcast.createContext({
...
var MessageList$1 = function (_React$Component) {
	...
	MessageList.prototype.render = function render() {
		return React.createElement(
			MessageListProvider,
			{ value: this._context },
			React.createElement(StyledList$1, _extends({}, this.props, { innerRef: this._getListRef, onScroll: this._handleScroll }))
		);
	};
...
var MessageListItem$1 = function (_React$Component) {
	...
	function MessageListItem() {
		...
		return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this._unregisterFromMessageList = dataUtils.noop, _this._registerInMessageList = dataUtils.memoizeOne(function (register) {
			return function (ref) {
...
var ThemeProvider$2 = recompose.mapProps(function (props) {
	return _extends({}, props, {
		theme: parseTheme(dataUtils.merge(defaultTheme, props.theme || {}))
	});
})(emotionTheming.ThemeProvider);
...
var QuickReply = function (_React$Component) {
	...
	QuickReply.prototype.render = function render() {
		return React.createElement(StyledReply, _extends({}, this.props, { onClick: this._handleClick }));
	};
...
var withComposer = (function () {
	var mapComposerToProps = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : dataUtils.identity;
	return function (WrappedComponent) {
		var _class, _temp;
		...
		return _temp = _class = function (_React$Component) {
			...
			WithComposer.prototype.render = function render() {
				...
				return React.createElement(
					...
					{ quiet: true },
					function (context) {
						return React.createElement(WrappedComponent, _extends({}, _this2.props, mapComposerToProps(context, _this2.props)));
					}
				);
			};
...
var createStyledIcon = dataUtils.memoize(
...
var TextInput = function (_React$Component) {
	...
	TextInput.prototype.render = function render() {
		...
		return React.createElement(StyledInput, _extends({}, props, { inputRef: this._getRef }));
	};
	...
	ElementButtons.prototype.render = function render() {
		...
		return React.createElement(
			...
			buttons.map(function (_ref, index) {
				...
				return React.createElement(MessageButton, _extends({ key: key, label: text, onClick: _this2.handleButtonClick(key) }, buttonProps));
			})
		);
	};
...
var Link = function Link(props) {
	return React.createElement('a', _extends({}, props, { onClick: stopPropagation, rel: 'nofollow noopener', target: '_blank' }));
};
...
var Image = function Image(_ref) {
	...
	return React.createElement(
		...
		React.createElement(
			...
			null,
			React.createElement('img', _extends({ alt: '', className: imageStyle }, getThumbnailProps(url, srcset)))
		)
	);
};
...
var Card = function (_React$Component) {
	...
	Card.prototype.render = function render() {
		...
		return React.createElement(
			...
			card.image && React.createElement(CardImage, card.image),
			(card.title || card.subtitle) && React.createElement(MessageTitle, { subtitle: card.subtitle, title: card.title }),
			card.buttons && React.createElement(ElementButtons, { buttons: card.buttons, onButtonClick: onButtonClick })
		);
	};
...
var Carousel = function (_React$PureComponent) {
	...
	Carousel.prototype.render = function render() {
		...
		return React.createElement(
			...
			this.state.showScrollRight && React.createElement(
				ArrowButton,
				{ onClick: this.scrollToDirection(1), variant: 'right' },
				React.createElement(ArrowRightIcon, null)
			),
			this.state.showScrollLeft && React.createElement(
				ArrowButton,
